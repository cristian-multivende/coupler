...
(async () => {
  ...
  try {
    ...
    //
    const task = {
      ProductLinkId: "4252e146-90cb-4525-8fcd-cef5dc550894",
    ...
    await fcom.sendProductsCreateSynchronizationTasksCollectionToRemote(task, config.fcom);
    //

    console.log("Fin fcom-product-2.test");
  } catch (error) {
    console.error("Error fcom-product-2.test:");
