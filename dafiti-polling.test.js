...
(async () => {
  ...
  try {
    console.log("Inicio dafiti-polling.test");
    ...
    await dafiti.handlePollingOrder('', (remoteOrders) => {
      console.log(remoteOrders);
    }, '* * * * *', minutes);
    //

    console.log("Fin dafiti-polling.test");
  } catch (error) {
    console.error("Error dafiti-polling.test:");
